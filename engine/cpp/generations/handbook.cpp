...
// 35 :: HC:i:u~
// 36 :: H*C:i:u~
const ushort Handbook::atomsNum = 39;
const bool Handbook::__atomsAccordance[39 * 39] = {
...
const ushort Handbook::__hOnAtoms[39] =
{
    2, 1, 0, 2, 1, 0, 1, 1, 0, 1,
    2, 2, 1, 0, 3, 2, 1, 0, 2, 0,
    1, 0, 1, 0, 0, 3, 2, 1, 1, 2,
...
const ushort Handbook::__activesToH[39] =
{
    0, 3, 1, 3, 4, 6, 6, 7, 9, 9,
...
const ushort Handbook::__activesOnAtoms[39] =
{
    0, 1, 2, 0, 0, 1, 0, 0, 1, 0,
    0, 1, 2, 3, 0, 0, 1, 2, 0, 0,
    0, 1, 0, 0, 0, 0, 1, 2, 1, 1,
