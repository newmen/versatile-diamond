...
module VersatileDiamond
  module Mcs
    ...
    describe SpeciesComparator do
      ...
      describe "#self.make_mirror" do
        let(:mirror) { described_class.make_mirror(bridge_base, bridge_base_dup) }
        it { expect(mirror[bridge_base.atom(:ct)]).to eq(bridge_base_dup.atom(:t)) }
      end
    end
